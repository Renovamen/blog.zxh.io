...
#### Handling Failures: Hinted Handoff 故障处理
...
#### Handling permanent failures: Replica synchronization 副本同步

当故障发生或者有新节点加入、离开集群时，都涉及分片的拷贝和传输。因此希望能够快速检查分片中内容是否相同，并通过仅发送不同的部分来减少数据传输量。Dynamo采用 **Merkle Tree** 来解决这个问题。
...
#### Membership and Failure Detection 成员信息及故障检测
